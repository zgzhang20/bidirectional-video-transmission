...
class OffsetEncodeNet(nn.Module):
    ...
    def __init__(self, inp=out_channel_M):
        ...
        self.conv1 = nn.Conv2d(inp, out_channel_mv, 5, stride=1, padding=2)
        self.res1 = Resblocks(out_channel_mv)
        self.conv2 = nn.Conv2d(out_channel_mv, out_channel_mv, 5, stride=1, padding=2)
        self.res2 = Resblocks(out_channel_mv)
        self.conv3 = nn.Conv2d(out_channel_mv, 64, 5, stride=1, padding=2)
...
class OffsetDecodeNet(nn.Module):
    ...
    def __init__(self, out=out_channel_M):
        ...
        self.res2 = Resblocks(out_channel_mv)
        self.deconv3 = nn.ConvTranspose2d(out_channel_mv, out, 5, stride=1, padding=2, output_padding=1)
